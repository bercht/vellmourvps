...
%o`, message, error2, detail);
  ...
  var confirm_delete_controller_default = class extends Controller {
    static values = {
      message: String,
      url: String,
      method: String
  ...
  var image_preview_controller_default = class extends Controller {
    ...
    createImagePreview(src, fileName, index, fileSize) {
      ...
      <!-- Bot\xE3o de Remo\xE7\xE3o - MAIS DESTACADO -->
      <button type="button" 
  ...
  var sweetalert_controller_default = class extends Controller {
    ...
    show() {
      if (typeof Swal === "undefined") {
        console.error("SweetAlert2 n\xE3o est\xE1 carregado");
        return;
      }
      const config = {
        text: this.messageValue,
  ...
  var spotlight_controller_default = class extends Controller {
    ...
    connect() {
      console.log("\u{1F50D} Spotlight Controller conectado");
      setTimeout(() => {
        this.initializeSpotlight();
      }, 100);
    }
    disconnect() {
      console.log("\u{1F50D} Spotlight Controller desconectado");
      if (typeof Spotlight !== "undefined") {
        try {
          Spotlight.destroy();
        } catch (e) {
          console.log("Spotlight j\xE1 foi destru\xEDdo ou n\xE3o existe");
        }
      }
    }
    initializeSpotlight() {
      if (typeof Spotlight === "undefined") {
        console.warn("\u26A0\uFE0F Spotlight.js n\xE3o est\xE1 carregado ainda, tentando novamente...");
      ...
      try {
        ...
        console.error("\u274C Erro ao inicializar Spotlight:", error2);
      }
    }
  ...
  application.register("confirm-delete", confirm_delete_controller_default);
  application.register("logout", logout_controller_default);
  ...
  application.register("spotlight", spotlight_controller_default);

  // app/javascript/app.js
  console.log("\u{1F525} Application.js carregado!");
})();
